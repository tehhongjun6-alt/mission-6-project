...
![DeviceNest dashboard](https://github.com/user-attachments/assets/06ee684c-c025-41f0-9f98-4cdc6ae4dee2)

## Features

- **Login flow** - log in with demo credentials, protected by a route guard
- **Route guard** - visiting `/dashboard` without logging in redirects you to `/login`
